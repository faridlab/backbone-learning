//! EmployeeCompetency DTOs (Data Transfer Objects)
//!
...
/// Request DTO for creating a new EmployeeCompetency
///
...
/// Request DTO for full update of a EmployeeCompetency
///
...
/// Request DTO for partial update of a EmployeeCompetency
///
...
pub struct PatchEmployeeCompetencyDto {
    ...
    #[serde(skip_serializing_if = "Option::is_none", alias = "assessed_at")]
    pub assessed_at: Option<NaiveDate>,
}
...
/// Response DTO for EmployeeCompetency entity
///
...
/// Paginated list response for EmployeeCompetency entities
///
...
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[serde(rename_all = "camelCase")]
pub struct EmployeeCompetencyListResponseDto {
    /// List of items
    pub items: Vec<EmployeeCompetencyResponseDto>,
...
impl From<EmployeeCompetency> for EmployeeCompetencyResponseDto {
...
impl From<EmployeeCompetency> for EmployeeCompetencySummaryDto {
    fn from(entity: EmployeeCompetency) -> Self {
...
impl From<CreateEmployeeCompetencyDto> for EmployeeCompetency {
...
impl From<&EmployeeCompetency> for EmployeeCompetencyResponseDto {
    fn from(entity: &EmployeeCompetency) -> Self {
        Self {
            ...
            assessed_at: entity.assessed_at.clone(),
            metadata: entity.metadata.clone(),
        }
    }
}

impl backbone_core::FromCreateDto<CreateEmployeeCompetencyDto> for EmployeeCompetency {
    fn from_create_dto(dto: CreateEmployeeCompetencyDto) -> backbone_core::ServiceResult<Self> {
        Ok(EmployeeCompetency::from(dto))
    }
}
...
impl backbone_core::ApplyUpdateDto<UpdateEmployeeCompetencyDto> for EmployeeCompetency {
    fn apply_update(mut self, dto: UpdateEmployeeCompetencyDto) -> backbone_core::ServiceResult<Self> {
        ...
        self.assessed_at = dto.assessed_at;
        Ok(self)
    }
}
