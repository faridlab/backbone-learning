...
metaphor migration generate Invoice learning
metaphor migration run
...
(`learning` is your module name — auto-detected from the current directory when omitted, but
...
```bash
metaphor migration seed learning          # run Rust seeders
metaphor migration generate-seeds learning  # emit SQL seed files
```
