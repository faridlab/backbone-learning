//! Specifications for EmployeeSkill aggregate
//!
...
// Each predicate implements `Specification<EmployeeSkill>` and can be combined
...
//
// pub struct ActiveEmployeeSkillSpec;
// impl Specification<EmployeeSkill> for ActiveEmployeeSkillSpec {
//     fn is_satisfied_by(&self, e: &EmployeeSkill) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
