...
/// Request DTO for full update of a Skill
///
...
/// Request DTO for partial update of a Skill
///
...
/// Paginated list response for Skill entities
///
...
pub struct SkillListResponseDto {
    /// List of items
    pub items: Vec<SkillResponseDto>,
...
impl SkillListResponseDto {
    /// Create a new list response from items and pagination info
    pub fn new(items: Vec<SkillResponseDto>, total: u64, page: u32, per_page: u32) -> Self {
...
impl From<Skill> for SkillSummaryDto {
    fn from(entity: Skill) -> Self {
...
impl From<CreateSkillDto> for Skill {
...
impl backbone_core::FromCreateDto<CreateSkillDto> for Skill {
    fn from_create_dto(dto: CreateSkillDto) -> backbone_core::ServiceResult<Self> {
        Ok(Skill::from(dto))
    }
}
