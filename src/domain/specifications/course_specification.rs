//! Specifications for Course aggregate
//!
...
// Each predicate implements `Specification<Course>` and can be combined
...
//
// pub struct ActiveCourseSpec;
// impl Specification<Course> for ActiveCourseSpec {
//     fn is_satisfied_by(&self, e: &Course) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
