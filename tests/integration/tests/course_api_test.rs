...
//!
//! Tests the Course CRUD API endpoints.
...
// ============================================================================
// COURSE TEST DATA GENERATOR
// ============================================================================

/// Test data generator for Course
pub struct CourseTestData;

impl TestDataGenerator for CourseTestData {
...
pub struct CourseApiTest {
    inner: GenericCrudTest<CourseTestData>,
}

impl CourseApiTest {
    pub fn new() -> Self {
        let mut config = CrudTestConfig::new("/api/v1/courses", "Course");
        config.supports_soft_delete = true;
        Self {
            inner: GenericCrudTest::new(config, CourseTestData),
        }
    }
...
impl Default for CourseApiTest {
    fn default() -> Self {
        Self::new()
    }
}
...
// <<< CUSTOM TESTS START >>>
// Add Course specific tests here
// <<< CUSTOM TESTS END >>>
